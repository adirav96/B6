    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="mt-8 flex gap-4">
          ...
          <button onClick={() => router.push(`/session/${problemId}`)} className="flex-1 border border-gray-200 text-gray-700 hover:bg-gray-50 font-medium py-3 px-6 rounded-xl transition-colors">
